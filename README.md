...
+ Configuration
    * depends mostly on Bitbucket, Bitbucket internal [Markdown](https://en.wikipedia.org/wiki/Markdown). In the future, can occur a migration to [Github](https://github.com/). Most depends on our proxy server's _mood_.
+ Dependencies
